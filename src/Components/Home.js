      ...
      <div className='row page-container'>
        <div className='col-lg-3' style={{ backgroundColor:"white", color: "grey", borderRadius:"80px", border:"2px solid grey"}}>
          ...
          <b><p> <a style={{color: "grey"}} className="nav-link" href="/">Home</a></p></b>
            <b><p> <a style={{color: "grey"}} className="nav-link" href="http://localhost:3000/Stories">Stories</a></p></b>
             <b><p> <a style={{color: "grey"}} className="nav-link" href="http://localhost:3000/Quiz">Quiz</a></p></b>
            <b><p><a style={{color: "grey"}} className="nav-link" href="http://localhost:3000/FAQs">FAQ's</a></p> </b> 
            <b><p><a style={{color: "grey"}} className="nav-link" href="http://localhost:3000/Timer">Timer</a></p> </b> 
